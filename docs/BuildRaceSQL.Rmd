...
stl90 <- select(stl90, -tract.x)
names(stl90)[names(stl90) == "tract.y"] <- "tract"
# stl90 <- rename(stl90, tract = tract.y)
...
stl00 <- select(stl00, -tract.x)
names(stl00)[names(stl00) == "tract.y"] <- "tract"
...
stl10 <- select(stl10, -tract.x)
names(stl10)[names(stl10) == "tract.y"] <- "tract"
